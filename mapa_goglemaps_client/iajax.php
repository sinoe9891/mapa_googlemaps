...
switch ($ac) {
    case "grabar":
        $p = new puntosDao();
        $exito = $p->grabar($_POST["titulo"], $_POST["cx"], $_POST["cy"], $_POST["pais"], $_POST["rubro"], $_POST["area_tematica"]);
        if($exito)
        {
            $r["estado"] = "ok";
    ...
    case "actualizar":
        $p = new puntosDao();
        $exito = $p->actualizar($_POST["id"], $_POST["titulo"], $_POST["cx"], $_POST["cy"], $_POST["pais"], $_POST["area_tematica"], $_POST["rubro"]);
        if($exito)
        {
            $r["estado"] = "ok";
